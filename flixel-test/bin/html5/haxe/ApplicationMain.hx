...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("flixel-test", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("flixel-test", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "flixel-test";
		app.meta["name"] = "flixel-test";
